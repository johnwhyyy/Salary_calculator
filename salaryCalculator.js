...
class SalaryCalculator {
    ...
    calculateAndPlotNextRankSalary(nextRank) {
        ...
        const legacySalary = this.rankSalaries[nextRank].percentile25;
        const legacySalaries = effortLevels.map(effort => ({ x: effort, y: legacySalary }));
